...
Die Demo registriert eine Activity plus CSS-, Tailwind- und JS-Assets über `web.Module(web.ConventionalAssets(...), web.BindActivity(...))`, rendert eine `web.Page` und nutzt dieselbe zentrale `web`-Runtime wie die spätere Anwendung.
